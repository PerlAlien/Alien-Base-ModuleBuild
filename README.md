# Alien::Base::ModuleBuild [![Build Status](https://secure.travis-ci.org/Perl5-Alien/Alien-Base-ModuleBuild.png)](http://travis-ci.org/Perl5-Alien/Alien-Base-ModuleBuild)
